  ...
  return (
    <AuthLayout>
      <Card className="p-6 sm:p-10">
        ...
        <p className="text-sm text-muted2 mb-6 sm:mb-8">
        ...
        <form onSubmit={handle} className="space-y-1">
          <Input
            label="Email"
            icon="✉"
            type="email"
          ...
          <Button
            variant="primary"
            loading={loading}
            className="w-full py-3 sm:py-3.5 text-sm sm:text-base"
            type="submit"
          >
            Sign In →
          </Button>
      ...
      <p className="text-center mt-4 sm:mt-5 text-sm text-muted2">
        ...
        <Link
          to="/signup"
          className="text-green font-semibold hover:opacity-80"
        >
          Create one free →
        </Link>
      </p>
